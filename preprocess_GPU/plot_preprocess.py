...
g = dgl.graph(('csr', (row_ptr_dir, col_idx_dir, [])))
...
plt.xlabel('Degree of Vertex', fontsize=36)
...
plt.annotate(str(highest_y), xy=(highest_x, highest_y), ha='center', va='bottom', fontsize=24)
