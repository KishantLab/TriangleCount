                               ...
                               unsigned long long num_edges)
{
    ...
    for (unsigned long long value = 0; value < nopart; ++value)
    {
        ...
        cout<<"Time measured for convert: "<<elapsed5<<" seconds."<<endl;
        ...
        // cout<<endl;
         ...
         struct timeval begin8, end8;
        gettimeofday(&begin8, 0);
        ...
        gettimeofday(&end8, 0);
        long seconds8 = end8.tv_sec - begin8.tv_sec;
        long microseconds8 = end8.tv_usec - begin8.tv_usec;
        double elapsed8 = seconds8 + microseconds8*1e-6;
        cout<<"Time measured for sorting col idx: "<<elapsed8<<" seconds."<<endl;
        total_kernel_time += elapsed8;
        ...
        // {
            ...
            cudaMallocManaged(&temp_arr1, new_combined_node_s * sizeof(unsigned long long));
            ...
            // Allocate temporary storage for inclusive prefix sum
            cudaMallocManaged(&d_temp_storage9, temp_storage_bytes9);
            ...
            cout<<"Total Edges after clean: "<<temp_arr_sum1[new_combined_node_s-1]<<endl;
						...
						cout<<"Time measured part: "<<elapsed_exe<<" seconds."<<endl;
						// cout << "Kernel code completed" << endl;
    ...
    cout<<"Total Kernel Time: "<<total_kernel_time<<" seconds."<<endl;
		cout<<"Total execution Time: "<<total_exe_time<<" seconds."<<endl;
   outfile.close();
}
