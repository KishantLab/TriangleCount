...
node_parts = np.zeros(Nodes, dtype=int)  # create an array of size n filled with zeros

for i in range(nopart):
    node_parts[i*l:(i+1)*l] = i  # fill each part of the array with the corresponding number
print(node_parts)  # print the resulting array
